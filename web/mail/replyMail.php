...
<tr class=tro>
  ...
  <td width=700 align=left>&nbsp;&nbsp;<input size=15 name="to_user" value="<?php echo $mail[1]; ?>" /> (Write Receiver's User Id here) </td>
  <td width=70></td>
</tr>
<tr class=tre>
  <td></td>
  <td align=right><strong>Title:&nbsp;&nbsp;</strong></td>
  <td align=left>&nbsp;&nbsp;<input size=80 name="title" value="Re:<?php echo $mail[2]; ?>" /></td>
  <td></td>
</tr>
<tr class=tro>
  <td></td>
