...
<jsp:useBean id="javaREBean" class="com.whu.noah.beans.status.JavaREBean" scope="page" />
<jsp:setProperty name="javaREBean" property="dataSource" value="${appDataSource}" />
<jsp:setProperty name="javaREBean" property="solution_id" value="${param.solution_id}" />

<head>
  <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
  <title>Java Runtime Error</title>
...
<center>
  ...
  <div id="main">
   <br />
   <div>
     <span class="cl">Java Runtime Error</span>
   </div>
   <br />
   <div class="ptt">Information</div>
   <div class="code"><pre>${javaREBean.error}</pre></div>
  </div>
