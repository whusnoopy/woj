<?php
	...
	echo '<div id=tt>Frequently Asked Questions</div>';
...
END.</pre></div>
    ...
    <div class=styCode><pre>
The Java compiler is jdk 1.5 recently, below is a program for problem 1001
...
public class Main
{
    ...
    limits for Java programs are longer(exactly <span class=styRed>five
    ...
    <div class="ptt">Q: My program exceeds the time limit by just 314MS. How can
    I improve it?</div>
    <div class="ptx">
