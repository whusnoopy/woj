...
//		user_pref("capability.policy.localfilelinks.checkloaduri.enabled", "allAccess");
		...
		return str.replace(pattern, "<img src=\"file:///");
	}else{
		alert("You navigator do not support this operate");
	}
}
...
function changemodel()
{
	...
	else
	{
		...
		em("html").innerHTML = showhtml(em("description").value);
...
{
	em("description").value = showhtml(em("description").value);
