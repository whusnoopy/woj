...
<center>
  ...
  <div id="main">
	...
	<tr class=tro><td><a href="status.php"></a></td></tr>
	<tr class=tro><td><a href="setting/setNotice.php">Set notice infomation</a></td></tr>
	<tr class=tro><td><a href="setting/setHomepage.php">Set homepage</a></td></tr>
    <tr class=tro><td><a href="problem/addProblem.php">Add a new problem</a></td></tr>
    <tr class=tre><td><a href="problem/problemList.php">See the problem list</a></td></tr>
    <tr class=tro><td><a href="contest/addContest.php">Add a new contest</a></td></tr>
    <tr class=tre><td><a href="contest/contestList.php">See the contest list</a></td></tr>
    <tr class=tro><td><a href="judge/adminsubmit.php">Submit in Admin's Home</a></td></tr>
    <tr class=tre><td><a href="adminstatus.php">See the status in Admin's Home</a></td></tr>
