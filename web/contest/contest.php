...
<?php
 ...
 /* <c:if test="${! fn:contains(contestType, 's')}">
    <span class="bt"><a href="contestStanding.php?contest_id=${param.contest_id}&num=${pcList.rowCount}&start=0&contestType=${contestType}&contestName=${contestBean.title}">
    Standing</a></span>&nbsp;&nbsp;
    <span class="bt"><a href="../status/status.php?contest_id=${param.contest_id}">
    Status</a></span>&nbsp;&nbsp;
    <span class="bt"><a href="contestStatistics.php?contest_id=${param.contest_id}&contestType=${contestType}&contestName=${contestBean.title}">
    Statistics</a></span>
  </c:if>
 */
?>
