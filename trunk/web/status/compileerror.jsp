...
<jsp:useBean id="compileErrorBean" class="com.whu.noah.beans.status.CompileErrorBean" scope="page" />
<jsp:setProperty name="compileErrorBean" property="dataSource" value="${appDataSource}" />
<jsp:setProperty name="compileErrorBean" property="solution_id" value="${param.solution_id}" />
...
<center>
  ...
  <div id="main">
   <br />
   <div>
     <span class="cl">Compile Error</span>
   </div>
   <br />
   <div class="ptt">Information</div>
   <div class="code"><pre>${compileErrorBean.error}</pre></div>
  </div>
